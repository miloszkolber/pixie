...
The current service embeds a pinned SDK under Bun. Native subprocess RPC has different response and administration semantics. Preserve observable features and ownership, not TypeScript structure. The [second review](second-pass-review.md) identifies additional migration blockers.
