...
function passingComposition(): CompositionInput {
	const assistantSources = {
		...
		"assistant/internal/supervisor/supervisor.go":
			"package supervisor\n\ntype Supervisor struct{}\n",
		"assistant/cmd/main.go":
...
test("composition rejects a missing facade, controller-internal imports and nonlocal replacement", () => {
