...
test("container validation builds both immutable Pixie product images without publication", async () => {
	...
	expect(workflow).toContain("--target pixie");
	...
	expect(workflow).toContain(`ghcr.io/${repositoryOwner}/pixie:${releaseId}`);
