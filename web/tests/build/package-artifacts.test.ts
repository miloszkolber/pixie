...
`;
	return {
		...
		units: {
			"web/systemd/pixie-assistant.service": assistantUnit,
			"web/systemd/pixie.service": hostUnit,
		},
		configs: {
			"web/systemd/assistant.json": '{"host":"127.0.0.1","port":3284}',
			"web/systemd/pixie.json": '{"host":"127.0.0.1","port":7312,"mode":"full-host"}',
		},
...
test("package checks reject split services, secret config and incomplete archive contents", () => {
	...
	const report = inspectPackageArtifacts({
		...
		configs: {
			"web/systemd/assistant.json": '{"PIXIE_MCP_TOKEN":"not-for-an-example"}',
			"web/systemd/pixie.json": "not-json",
		},
