...
- `host/`: Bun service using the unmodified Pi SDK, with optional agents and upstream extension profiles (`rpiv-todo`, `rpiv-web`, `rpiv-ask`, `signet`, `pi-subagent`, `pi-mcp-adapter`, `llama`) under `src/extensions/`.
