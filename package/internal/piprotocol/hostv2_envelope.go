// Host v2 envelope schemas for API-02 (contracts transport).
//
...
// Host v2 transport close codes from contracts.md.
...
// Ordinary in-flight host bounds from contracts.md. Exceeding them answers
