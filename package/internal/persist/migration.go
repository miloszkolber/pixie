...
func KnownControllerInventory() []InventoryEntry {
	return []InventoryEntry{
		...
		{File: "pi-pairing-authority.json", Owner: "Pairing authority", Handling: HandlingPreserve, Schema: "v1/pi", Note: "Preserve paired status, binding ID, host identity, storage key and generation; never restore an older pairing over a newer authority and never rewind a revocation."},
