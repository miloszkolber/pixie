...
async function load(): Promise<void> {
	...
	const [nextCatalog, nextRegistryCatalog, nextExtensions, nextTools] = await Promise.allSettled([
	...
	const failures = [nextCatalog, nextRegistryCatalog, nextExtensions, nextTools].filter(
