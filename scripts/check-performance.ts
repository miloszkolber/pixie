...
export const PERFORMANCE_VARIANTS = ["assistant"] as const;
...
export const PERFORMANCE_USAGE = [
	...
	"performance-evidence.json and reports every absent target.",
	"",
	"--input (or the legacy positional path) consumes the raw two-target",
