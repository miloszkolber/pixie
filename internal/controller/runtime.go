...
func runtimeRemediationHints(report RuntimeDiagnosticsReport) []string {
	...
	if configured == nil {
		...
		hints = append(hints, "Assistant host is unreachable: verify pixie serve is running on its configured loopback port and that config port and PIXIE_PI_PORT match.")
	}
