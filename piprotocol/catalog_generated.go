...
var CatalogHostOperationReasons = map[string]string{
	...
	"session.steer":           "Pi 0.86.1 exposes no public run identifier to bind a steering request to the active run.",
	...
	"pi.session.info":         "Pi 0.86.1 exposes no public nonresident session metadata beyond SessionManager.list.",
	...
	"pi.session.steer":        "Pi 0.86.1 exposes no public run identifier to bind steering to the active run.",
