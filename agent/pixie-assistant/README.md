...
The workspace's [subagent patch](../extensions/local-patches/README.md) does not travel with an independently installed optional package. Native child-launch compatibility remains a separate verification gate. The assistant does not install or patch the user's optional packages.
