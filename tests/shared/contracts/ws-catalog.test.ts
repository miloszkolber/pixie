...
import type { WsMethod, WsMethodName } from "../../../src/shared/ws-protocol";
import { WS_METHODS } from "../../../src/shared/ws-protocol";
...
test("ownership validation fails on unknown routes and over-advertised statuses", () => {
	...
	const schema = loadProtocolCatalog(
		resolve(import.meta.dir, "..", "..", "..", SCHEMA_RELATIVE_PATH),
	);
