...
function performanceMeasurement(architecture: "amd64" | "arm64", variant: "assistant") {
	return {
		architecture,
		variant,
...
test("performance producer emits blocked on absent input, pass on two targets and fail on an incomplete set", async () => {
