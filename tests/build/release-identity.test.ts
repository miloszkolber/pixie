...
jobs:
  ...
  release:
    ...
    run: stage pixie_web-${releaseId}-linux-amd64.tar.gz pixie_web-${releaseId}-linux-arm64.tar.gz pixie-${releaseId}-linux-amd64.tar.gz pixie-${releaseId}-linux-arm64.tar.gz checksums.txt release-manifest.json
